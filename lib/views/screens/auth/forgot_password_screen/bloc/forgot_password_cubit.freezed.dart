...
abstract class $ForgotPasswordStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ResponseItem? responseItem, String message});
}
...
class _$ForgotPasswordStateImpl implements _ForgotPasswordState {
  const _$ForgotPasswordStateImpl({this.responseItem, this.message = ''});
  ...
  @override
  String toString() {
    return 'ForgotPasswordState(responseItem: $responseItem, message: $message)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, responseItem, message);
